...
describe("ClearingHouse realizedPnl2", () => {
    ...
    it("has balanced realized PnL", async () => {
        ...
        console.log((await accountBalance.getPnlAndPendingFee(taker.address))[0].toString())
        ...
        console.log(findLiquidityChangedEvents(fixture, makerMoveLiquidityRemoveReceipt)[0].args.quoteFee.toString())

        console.log((await accountBalance.getPnlAndPendingFee(maker.address))[0].toString())
