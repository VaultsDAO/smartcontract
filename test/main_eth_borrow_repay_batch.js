...
contract("Factory", function (accounts) {
  ...
  it("new loan", async function () {
    ...
    rs = await shopFactory.batchRepayETH(
      '1',
      [loanId1, loanId2],
      [totalDebt1, totalDebt2],
      { value: totalDebt1.add(totalDebt2), from: borrower }
    );
    ...
    assert.isTrue(await utils.verifyETHBalance(borrower, preETHBalances[borrower], 0, gasCost.add(totalDebt1).add(totalDebt2)))
