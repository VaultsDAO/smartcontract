...
contract("Factory", function (accounts) {
  ...
  it("new loan", async function () {
   ...
   //  revert WETH: request exceeds allowance -- Reason given: WETH: request exceeds allowance.
     await truffleAssert.reverts(
           wethGateway.batchBorrowETH(
      '1',
    ...
    await weth.deposit({ value: web3.utils.toWei('0.2', 'ether'), from: lender });
     //revert  permission eth not enough amount
     await truffleAssert.reverts(
           wethGateway.batchBorrowETH(
      '1',
      [borrowAmount1, borrowAmount2],
     ...
     await truffleAssert.reverts(
           await wethGateway.batchBorrowETH(
      '1',
      [borrowAmount1, borrowAmount2],
      [testNft.address, testNft.address],
      ['1', '2'],
