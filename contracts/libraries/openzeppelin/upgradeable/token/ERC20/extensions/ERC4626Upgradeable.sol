...
/**
 * @dev Implementation of the ERC4626 "Tokenized Fragment Standard" as defined in
    ...
    IERC4626Upgradeable
{
    ...
    function maxDeposit(
        ...
        return _isFragmentCollateralized() ? type(uint256).max : 0;
    }
    ...
    function _deposit(
        ...
        // calls the fragment, which is assumed not malicious.
        //
    ...
    function _isFragmentCollateralized() private view returns (bool) {
