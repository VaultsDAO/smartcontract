...
npx hardhat run deployments/5_migrate_BaseToken_0.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/5_migrate_BaseToken_1BAYC.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/5_migrate_BaseToken_2MAYC.ts --network arbitrumGoerli --no-compile
...
npx hardhat run deployments/16_migrate_Init_Token_1BAYC.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/16_migrate_Init_Token_2MAYC.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/17_migrate_AddLiquidity_1BAYC.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/17_migrate_AddLiquidity_2MAYC.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/18_migrate_SetPrice_1BAYC.ts --network arbitrumGoerli --no-compile
npx hardhat run deployments/18_migrate_SetPrice_2MAYC.ts --network arbitrumGoerli --no-compile
